...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        *
        * <dl class="dl-horizontal">
        *   <dt>control</dt>               <dd><code>=</code> A reference to the Popup
        *                                  control created by this directive.</dd>
        *   <dt>fade-in</dt>               <dd><code>@</code> A boolean value that determines whether popups should be shown using a
        *                                  fade-in animation.</dd>
        *   <dt>fade-out</dt>              <dd><code>@</code> A boolean value that determines whether popups should be hidden using a
        *                                  fade-out animation.</dd>
        ...
        *   <dt>modal</dt>                 <dd><code>@</code> A boolean value that determines whether the @see:Popup should
        *                                  be displayed as a modal dialog.</dd>
        *   <dt>got-Focus</dt>            <dd><code>&</code> The @see:gotFocus event handler.</dd>
        *   <dt>lost-Focus</dt>           <dd><code>&</code> The @see:lostFocus event handler.</dd>
        ...
        *
        * <dl class="dl-horizontal">
        *   <dt>checked-member-path</dt>       <dd><code>@</code> The name of the property used to control the checkboxes
        *                                      placed next to each item.</dd>
        *   <dt>header-format</dt>             <dd><code>@</code> The format string used to create the header content
        *                                      when the control has more than <b>maxHeaderItems</b> items checked.</dd>
