            ...
            FlexGrid.prototype._updateContent = function (recycle, cells) {
                ...
                if (cells) {
                    ...
                    if (this._hdrVis & 1 /* Column */) {
                        ...
                        this._eCHdr.scrollLeft = 0; // work around IE bug
                    }
                    if (this._hdrVis & 2 /* Row */) {
                        this._gpRHdr._updateContent(recycle, this._offsetY);
                        this._eRHdr.scrollTop = 0; // work around IE bug
                    }
        ...
        var GridPanel = (function () {
            ...
            */
            GridPanel.prototype._updateContent = function (recycle, offsetY, cells) {
                ...
                // done if recycling, no specific cells to refresh,
                // and old range contains new (unbuffered)
                // this happens a lot while scrolling by small amounts (< 1 cell)
                if (recycle && !cells && !rows.frozen && !cols.frozen && this._rng.contains(vrng)) {
                    return;
                }
            ...
            */
            CellFactory.prototype.updateCell = function (panel, r, c, cell, rng, updateContent) {
                ...
                if (ct == 1 /* Cell */) {
                    ...
                    if (g.editRange && col.dataType != 3 /* Boolean */ && g.editRange.contains(r, c)) {
                        selState = 0 /* None */;
                    }
                    ...
                    if (ct == 1 /* Cell */ && c == g.columns.firstVisibleIndex && gr && gr.hasChildren && !this._isEditingCell(g, r, c)) {
                        ...
                        if (!col.dataMap && !col.mask) {
                            ...
                            if (wijmo.isNumber(val)) {
                                var fmt = content.indexOf('%') < 0 ? 'g12' : 'p12';
            ...
            _SelectionHandler.prototype.select = function (rng, show) {
                ...
                switch (g.selectionMode) {
                    ...
                    case 5 /* ListBox */:
                        ...
                        g.refreshCells(false, true, [new _grid.CellRange(0, 0, g.rows.length - 1, g.columns.length - 1)]);
                        break;
                }
            ...
            */
            ...
            _MouseHandler.prototype._mouseDown = function (e) {
                ...
                if (e.target != document.activeElement && !g.containsFocus()) {
                    // travel up to cell in case the target is not an element (TFS 78295)
                    var cell = e.target;
                    while (cell && !(cell instanceof HTMLElement) && cell instanceof Node) {
        ...
        */
        var _EditHandler = (function () {
            ...
            */
            ...
            // handle blur on grid and on listbox
