            ...
            */
            function ListBox(element, options) {
                ...
                */
                ...
                /**
                * Occurs before the items in the list are generated.
                */
                this.loadingItems = new wijmo.Event();
                /**
                * Occurs after the items in the list are generated.
                */
                ...
                */
                ...
                // make sure the list can get the focus (Chrome)
                var e = this.hostElement;
                if (e.tabIndex < 0 && !e.getAttribute('tabindex')) {
                    e.tabIndex = 0;
                }
            ...
            ListBox.prototype.showSelection = function () {
                ...
                if (index > -1 && index < count) {
                    ...
                    if (rco.bottom > rcc.bottom) {
                        this.hostElement.scrollTop += rco.bottom - rcc.bottom;
                    } else if (rco.top < rcc.top) {
                        this.hostElement.scrollTop -= rcc.top - rco.top;
                    }
                }
            };
            ...
            */
            ...
            ListBox.prototype._click = function (e) {
                for (var index = 0; index < this._div.childElementCount; index++) {
                    if (wijmo.contains(this._div.childNodes[index], e.target)) {
                        this.selectedIndex = index;
                        break;
                    }
                }
            ...
            ListBox.prototype._keypress = function (e) {
                if (!e.defaultPrevented) {
                    ...
                    if (e.charCode > 32 || (e.charCode == 32 && this._search)) {
                        ...
                        // perform search
                        var cnt = this._div.childElementCount;
            ...
            ListBox.prototype._getCheckbox = function (index) {
                var li = this._div.children[index];
            ...
            ListBox.controlTemplate = '<div wj-part="lb-content"></div>';
            return ListBox;
        })(wijmo.Control);
