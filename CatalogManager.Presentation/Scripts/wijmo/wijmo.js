...
(function (wijmo) {
    ...
    */
    var Globalize = (function () {
        ...
        * @param trim Whether to remove trailing zeroes from the result.
        ...
        */
        Globalize.parseFloat = function (value) {
            var dp = wijmo.culture.Globalize.numberFormat['.'], rx = new RegExp('[^0-9\\-\\' + dp + ']+', 'g'), neg = value.indexOf('-') > -1 || (value.indexOf('(') > -1 && value.indexOf(')') > -1) ? -1 : +1, pct = value != null && value.indexOf('%') > -1 ? .01 : 1;
            value = value.replace(rx, '').replace('-', '').replace(dp, '.');
    ...
    var Binding = (function () {
        ...
        */
        Binding.prototype.getValue = function (object) {
            ...
            for (var i = 0; i < this._parts.length && object != null; i++) {
...
(function (wijmo) {
    ...
    */
    var RequestErrorEventArgs = (function (_super) {
        ...
        /**
        * Initializes a new instance of an @see:ErrorEventArgs.
        *
