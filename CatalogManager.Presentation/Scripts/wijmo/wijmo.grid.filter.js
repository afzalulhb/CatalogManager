            ...
            var FlexGridFilter = (function () {
                            ...
                            if (cf) {
                                switch (cfs.type) {
                                    case 'condition':
                                        ...
                                        cfc.condition1.value = wijmo.changeType(cfs.condition1.value, col.dataType, col.format);
                                        cfc.and = cfs.and;
                                        cfc.condition2.operator = cfs.condition2.operator;
                                        cfc.condition2.value = wijmo.changeType(cfs.condition2.value, col.dataType, col.format);
                                        break;
                                    case 'value':
                                        var cfv = cf.valueFilter;
                ...
                */
                FlexGridFilter.prototype.closeEditor = function () {
                    if (this._divEdt) {
                        // close any open popups... TFS 112676
                        var dd = this._divEdt.querySelectorAll('.wj-control.wj-dropdown');
                        for (var i = 0; i < dd.length; i++) {
                            var ctl = wijmo.Control.getControl(dd[i]);
                            if (ctl)
